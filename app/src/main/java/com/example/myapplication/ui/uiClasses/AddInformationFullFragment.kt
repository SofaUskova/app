...
class AddInformationFullFragment : Fragment() {
    ...
    private fun initListeners(view: View) {
        ...
        deleteError(inputEditTextInfo, inputTextInfo)
        ...
        extendedFabPush.setOnClickListener {
            ...
            if (isNotEmptyEditText()) {
                ...
                val gender = getGenderType(arguments?.getString("gender", GenderType.FEMALE.value)!!)
                val location =
                    Location( (arguments?.get("extras") as Bundle).getInt("locPosition"), "Россия", (arguments?.get("extras") as Bundle).getString("loc")!!)
                val docType = getDocType((arguments?.get("extras") as Bundle).getString("docType", DocType.PASSPORT.value))
                ...
                addInformationFullFragment.addDocument(newDocument, view, horse)
            }
        }
    }
    ...
    private fun setError() {
        ...
        if (inputEditTextInfo.text.isNullOrEmpty()) inputTextInfo.error = "Заполните поле"
    }
